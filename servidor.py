...
#Start Bia's direct server.
bia_dht = DHT()
bia_direct = Net(passive_bind="192.168.0.46", passive_port=44446, interface="eth0:3", net_type="direct", node_type="active", dht_node=bia_dht, debug=1)
bia_direct.start()
